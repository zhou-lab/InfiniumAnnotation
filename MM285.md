...
Please note that you need sesame ([stable release](https://bioconductor.org/packages/release/bioc/html/sesame.html), [development](https://bioconductor.org/packages/devel/bioc/html/sesame.html)) version 1.9+ for native mouse array support. For previous versions, you need to supply the custom sesame order file for mouse array. 
```R
library(sesame)
